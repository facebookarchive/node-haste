...
Warning.prototype.render = function() {
  return cli.bold('Warning') + ': [' + this.code + '] ' +
...
Error.prototype.render = function() {
  return cli.awesome('Error') + ': [' + this.code + '] ' +
    Message.prototype.render.call(this);
};
 ...
 * @extends {Message}
 */
function ClowntownError(file, code, text) {
  Message.call(this, file, code, text);
}
...
ClowntownError.prototype.render = function() {
  ...
  return clowntown + ' ' + cli.awesome('Error') + ': [' + this.code + '] ' +
    Message.prototype.render.call(this);
};
...
MessageList.prototype.addClowntownError = function(file, code, text) {
  return this.add(new ClowntownError(file, code, text));
};
